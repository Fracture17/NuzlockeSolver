...
# gDisplayedStringBattle — does not follow a uniform offset pattern in RnB.
# vanilla: 0x02022E2C  RnB: 0x0202312E  (RnB is +0x302 higher, not lower)
_BATTLE_TEXT_ADDR = 0x0202312E if GAME_MODE == 'rnb' else 0x02022E2C
